...
namespace Ducktastic
{
    public class MeshDestroy : MonoBehaviour
    {
        ...
        {
            var originalMesh = GetComponentInChildren<MeshFilter>().mesh;
        ...
        public class PartMesh
        {
            ...
            public void MakeGameobject(MeshDestroy original)
            {
                ...
                var mesh = new Mesh();
                mesh.name = original.GetComponentInChildren<MeshFilter>().mesh.name;
                ...
                renderer.materials = original.GetComponentInChildren<MeshRenderer>().materials;
